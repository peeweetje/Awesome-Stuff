...
var Init = /** @class */ (function (_super) {
    ...
    Init.prototype.runInit = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var files, endpointDefinitionPath, endpointPrismaYml, newEndpointPrismaYml, endpointSteps, endpointDir, endpointCreatedFiles, endpointDialog, results, prismaYmlString, definitionPath, prismaYml, newPrismaYml, dir, isLocal, steps, createdFiles, child, stderr, stdout, status_1, error, dockerComposeInstalled;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (endpoint) {
                            fs.writeFileSync(path.join(this.config.definitionDir, 'datamodel.prisma'), fs.readFileSync(path.join(__dirname, 'boilerplate', 'datamodel.prisma')));
                            fs.writeFileSync(path.join(this.config.definitionDir, 'prisma.yml'), fs.readFileSync(path.join(__dirname, 'boilerplate', 'prisma.yml')));
                    ...
                    case 1:
                        results = _b.sent();
                        prismaYmlString = "endpoint: ENDPOINT\ndatamodel: datamodel.prisma";
                        ...
                        if (results.generator && results.generator !== 'no-generation') {
                            ...
                            child = npm_run_1.spawnSync('prisma', ['generate']);
